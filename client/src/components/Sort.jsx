...
const Sort = ({ options, onSort, SortedOption }) => {
    ...
    return (
        <div className="relative w-full clashdisplay">
            <div
                className="w-full flex items-center justify-between bg-[#C7D3A6] capitalize text-[#1B2D11] font-normal text-[8px] md:text-xs lg:text-base p-2 md:p-3 lg:p-4 cursor-pointer h-10 md:h-12 lg:h-14"
