...
const Steps = () => {
  return (
    <div className='py-6 md:py-10 xl:py-14 clashdisplay'>
      <h1 className='boska uppercase text-[#859F3E] font-normal text-xs md:text-lg lg:text-[1.75rem] mb-4 md:mb-8 lg:mb-12'>How to Post Your Property In 3 Easy Steps</h1>
