              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-6">
                {formData.map((item, index) => (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[#F6FCDF] buda font-normal text-sm md:text-lg lg:text-2xl old-standard-tt">
                          {item.label}
                        </FormLabel>
                        <FormControl>
                          {item.name !== "intrested" ? (
                ...
                <div className="py-4 md:py-8 lg:py-16 flex justify-center">
