  ...
  return (
    <div className="flex flex-col lg:flex-row items-start justify-center gap-4 lg:gap-11 py-6 md:py-10 xl:py-14">
      <div className="flex flex-col items-start justify-start gap-0.5 lg:gap-5 w-full sm:w-[90%] md:w-[80%] lg:w-[495px]">
        <p className="boska font-normal text-[#859F3E] text-base md:text-xl lg:text-[1.75rem] leading-tight uppercase text-left">
          Farm Exchange
        </p>
        ...
        <div className="relative">
          ...
          <div className="absolute w-full h-full lg:w-4/5 lg:h-3/5 bg-[#073D2C]/80 lg:bg-[#073D2C] inset-0 lg:translate-1/2 lg:-translate-x-[90%] p-2 md:p-4 lg:p-8 flex flex-col items-center lg:items-start justify-between">
            <motion.div
              ...
              transition={{ duration: 1.0 }}
            >
              <p className="uppercase text-[#F6FCDF] font-normal text-base md:text-2xl md:text-[2rem] lg:text-3xl leading-tight">
                {carouselData[currentIndex].title}
              </p>
              <p className="text-[#D4E0AF] font-normal text-xs md:text-base lg:text-xl leading-tight">
            ...
            <div className="flex gap-4 w-full items-start">
              <button
                ...
                className="size-10 sm:size-12 flex items-center justify-center bg-[#859F3E] rounded-full hover:bg-[#5e722d] active:scale-50 ease-in duration-300 disabled:bg-[#c7d3a7]"
              >
