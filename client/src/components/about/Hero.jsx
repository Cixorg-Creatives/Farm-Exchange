...
const Hero = () => {
    return (
        <div className='flex flex-col-reverse xl:flex-row items-center justify-between my-6 md:my-10 xl:my-14'>
            <div className='w-full mt-14 xl:mt-0 xl:w-7/12'>
                <p className='prata text-[#31511E] font-normal text-4xl sm:text-5xl md:text-6xl xl:text-8xl leading-tight uppercase mb-10 sm:mb-14'>The Story Behind Farm exchange</p>
            ...
            <div className='flex flex-col-reverse xl:flex-col items-end justify-between gap-16 sm:gap-20 xl:gap-28'>
                <div className='flex items-end'>
                    <div className='h-60 sm:h-72 md:h-80 xl:h-96 border-l-[2px] border-dashed border-[#859F3E]'></div>
                    <div className='flex flex-col items-start'>
                        <img src={assets.about_3} alt="" className='w-72 sm:w-80 md:w-[24rem] xl:w-[30rem] h-80 sm:h-96 md:h-[28rem] xl:h-[34rem] ml-4 sm:ml-6 xl:ml-9 mb-4 sm:mb-5 xl:mb-8' />
                        <div className='w-1/2 border-t-[2px] border-dashed border-[#859F3E]'></div>
                    </div>
                </div>
                <div className='flex flex-col items-end justify-center'>
                    <p className='uppercase prata text-[#073D2C]/50 font-normal text-5xl sm:text-6xl md:text-7xl xl:text-8xl leading-tight text-center xl:text-right'>About us</p>
