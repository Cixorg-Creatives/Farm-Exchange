...
const data = [
  ...
  {
    index: "02",
    title: "Seamless Property Navigation",
    image: assets.services_2,
  },
  {
    index: "03",
    title: "Direct Communication with Buyers",
    image: assets.services_3,
  },
  {
    index: "04",
    title: "Customized Marketing Solutions",
    image: assets.services_4,
  },
];
              ...
              >
                <div className="flex items-center gap-5 md:gap-7 lg:gap-10">
                  <motion.p
                    ...
                    className="boska text-[#B3B3B3] font-bold text-sm md:text-lg lg:text-2xl"
                  >
                    {item.index}
                  </motion.p>
                  <motion.p
                    variants={textAnimation}
                    animate={hovered === index ? "hover" : "exit"}
                    className="capitalize text-[#02542D] font-normal text-base md:text-2xl lg:text-[2.5rem]"
                  >
                    {item.title}
                  </motion.p>
                </div>
