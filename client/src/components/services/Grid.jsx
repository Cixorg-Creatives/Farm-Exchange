      ...
      <Link className='relative group overflow-hidden col-span-1 lg:row-span-3 rounded-2xl h-[15rem] sm:h-[18rem] md:h-[36rem]'>
        ...
        <div className='absolute inset-0 bg-black/40 rounded-2xl p-5 md:p-6'>
          <div className='h-full flex flex-col items-start justify-end lg:justify-start gap-2 md:gap-3 duration-200 ease-in'>
            <p className='uppercase boska text-[#F6FCDF] font-normal text-xl md:text-3xl lg:text-[3.25rem] leading-tight w-full text-right lg:text-start'>Farm Land</p>
            <p className='uppercase text-[#F6FCDF] font-light text-sm md:text-base lg:text-2xl leading-tight text-right lg:text-start'>Buy, Sell & Invest in Farm Lands with Ease</p>
      ...
      <Link className='relative group overflow-hidden col-span-1 lg:col-span-2 rounded-2xl lg:row-span-3 h-[15rem] sm:h-[18rem] md:h-[36rem]'>
        ...
        <div className='absolute inset-0 bg-black/40 rounded-2xl p-5 md:p-6'>
          <div className='flex flex-col items-start justify-end gap-2 md:gap-3 duration-200 ease-in h-full w-full md:w-1/2'>
            <p className='uppercase boska text-[#F6FCDF] font-normal text-xl md:text-3xl lg:text-[3.25rem] leading-tight w-full text-right lg:text-start'>Coffee Estate</p>
            <p className='uppercase text-[#F6FCDF] font-light text-sm md:text-base lg:text-2xl leading-tight text-right lg:text-start'>Buy, Sell & Invest in Coffee Estate with Ease</p>
            {/* <p className='text-[#859F3E] text-xs sm:text-base md:text-xl font-normal leading-7 flex items-center w-full justify-end lg:justify-start gap-1 md:gap-2 lg:gap-3'>Explore Now <ArrowUpRight className='size-3 md:size-4 lg:size-5' /></p> */}
          </div>
        </div>
      </Link>
      <Link className='relative group overflow-hidden col-span-1 lg:col-span-2 rounded-2xl h-[15rem] sm:h-[18rem] md:h-[24rem]'>
        ...
        <div className='absolute inset-0 bg-black/40 rounded-2xl p-5 md:p-6'>
          <div className='flex flex-col items-start justify-end lg:justify-center gap-2 md:gap-3 duration-200 ease-in h-full w-full'>
            <p className='uppercase boska text-[#F6FCDF] font-normal text-xl md:text-3xl lg:text-[3.25rem] leading-tight w-full text-right lg:text-start'>Agriculture Land</p>
            <p className='uppercase text-[#F6FCDF] font-light text-sm md:text-base lg:text-2xl leading-tight text-right lg:text-start'>Buy, Sell & Invest in Agriculture <br /> Land with Ease</p>
            {/* <p className='text-[#859F3E] text-xs sm:text-base md:text-xl font-normal leading-7 flex items-center w-full justify-end lg:justify-start gap-1 md:gap-2 lg:gap-3'>Explore Now <ArrowUpRight className='size-3 md:size-4 lg:size-5' /></p> */}
          </div>
        </div>
      </Link>
