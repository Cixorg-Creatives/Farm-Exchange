    ...
    <div className='pt-6 md:pt-10 xl:pt-14 old-standard-tt'>
      <div className="w-full flex flex-col lg:flex-row justify-between ">
        <div className="flex flex-col items-start justify-between gap-5 w-full lg:w-2/3">
          ...
          <div className="flex flex-col items-start justify-between gap-5 md:gap-7">
            <div className="flex flex-col gap-3 md:gap-4 lg:w-[43.75rem]">
              <p className="capitalize text-[#747474] font-normal text-lg md:text-xl">
              ...
              <p className="capitalize text-[#1E1E1E] font-normal text-lg md:text-xl">
                Nandi Hills, Chikballapur, Karnataka
              </p>
            </div>
            <div className="flex gap-2 md:gap-4 flex-wrap md:flex-nowrap">
              <p className="flex text-[#1E1E1E] font-bold text-4xl md:text-5xl text-end">
                <IndianRupee className="text-[#1E1E1E] size-8 md:size-10" /> 1.75
                <span className="text-3xl md:text-4xl pl-1 md:pl-2 h-full flex items-end">cr</span>
              </p>
              <p className="text-[#757575] font-normal text-lg md:text-xl h-full flex items-end justify-end pt-2.5 pb-0 md:pt-0 md:pb-0.5">
                Onwards
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-3 md:gap-4 w-full lg:w-[30.5rem] mt-6 lg:mt-0">
          <div className="bg-[#D9E1C3] p-4 md:p-5 w-full">
            <div className="flex items-end justify-start gap-1 capitalize">
              <p className="text-[#31511E] font-bold text-3xl md:text-4xl">10,890.0</p>
              <p className="text-[#859F3E] font-bold text-xl md:text-2xl">Sq ft</p>
            </div>
            <p className="capitalize text-[#5A744B] text-lg md:text-xl font-normal">Plot Area</p>
          </div>
          <div className="bg-[#D9E1C3] p-4 md:p-5 w-full">
            <p className="text-[#31511E] font-bold text-3xl md:text-4xl">1607</p>
            <p className="capitalize text-[#5A744B] text-lg md:text-xl font-normal">Price Per sq. Ft</p>
          </div>
          <div className="bg-[#C7D3A6] p-4 md:p-5 w-full">
            <div className="flex items-end justify-start gap-1 capitalize">
              <p className="text-[#31511E] font-bold text-3xl md:text-4xl">10,890.0</p>
              <p className="text-[#31511E] font-normal text-xl md:text-2xl">Acres</p>
            </div>
            <p className="capitalize text-[#5A744B] text-lg md:text-xl font-normal">Project Area</p>
            <p className="capitalize text-[#5A744B] text-lg md:text-xl font-normal">A little detailed information about individual card in 2 lines</p>
          </div>
        </div>
      </div>
