        ...
        <div className='my-6 md:my-10 xl:my-14 old-standard-tt'>
            <div className='relative grid grid-cols-2'>
                ...
                <div className='absolute inset-0 bg-black/30 flex pt-3.5 md:pt-7 lg:pt-14 flex-col'>
                    <p className='w-2/3 text-right text-white font-bold text-[3.4rem] md:text-9xl lg:text-[12.5rem] prata leading-relaxed'>Green </p>
                    <p className='w-[84%] text-right text-white font-bold text-[3.4rem] md:text-9xl lg:text-[12.5rem] prata leading-[50%]'>Fields </p>
                </div>
            </div>
        </div>
    )
