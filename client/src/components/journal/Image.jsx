    ...
    <div className='py-6 md:py-10 xl:py-14 old-standard-tt flex flex-col gap-5 md:gap-10 lg:gap-20'>
      <div className='flex items-center justify-center'>
        <div className='relative w-4/5 md:w-3/4 lg:w-[64%] pl-2 md:pl-4 lg:pl-8'>
          <p className='uppercase text-[#859F3E] font-medium text-2xl md:text-4xl lg:text-[3.5rem] leading-tight text-center'>Celebrating The inspiring Beauty Of Every Field </p>
      ...
      <div className='px-4 md:px-6 lg:px-24 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-2 md:gap-4 lg:gap-0'>
        <div className='capitalize text-[#747474] font-medium text-[10px] md:text-base lg:text-xl'>Our colourful gallery will let you discover the true side of farming . <br className='hidden lg:block' /> Each image is captured in its dedication, love of each field from <br className='hidden lg:block' /> the very first sprouts of spring to the yellow harvests of autumn. <br className='hidden lg:block' /> Observe the unity of nature and the naturers. </div>
        <Link to={'/services'}>
