...
const Footer = () => {
    return (
        <div className='relative w-full footer_bg'>
            <div className='bg-black/30 backdrop-blur-xs h-full w-full p-8 sm:p-12 md:p-16 lg:p-24 flex flex-col md:flex-row md:items-start lg:items-center md:justify-between gap-8 md:gap-12 lg:gap-0'>
