    ...
    <div className="py-6 md:py-10 xl:py-14">
      <div className="hidden xl:flex relative w-full h-full rounded-3xl">
        <img
          src={assets.home_12}
          alt=""
          className={`rounded-3xl w-full lg:h-[90vh] transition-all duration-700 ease-in-out ${
          ...
          <div className="h-full flex items-center justify-between pl-5">
            ...
            <div className="relative">
              <img
                src={assets.home_2}
                alt=""
                className={`h-52 w-52 rounded-r-3xl transition-all duration-700 ease-in-out ${
                  loaded ? "blur-0" : "blur-md"
                }`}
                loading="lazy"
                onLoad={() => setLoaded(true)}
      ...
      <div className="xl:hidden flex flex-col gap-2">
        <div className="relative w-full h-full rounded-xl">
          <img
            src={assets.home_1}
            alt=""
            className={`rounded-xl w-full h-full transition-all duration-700 ease-in-out ${
              loaded ? "blur-0" : "blur-md"
            }`}
            loading="lazy"
            onLoad={() => setLoaded(true)}
        ...
        <div className="h-32 md:h-44 flex items-center justify-between pl-4">
          ...
          <div className="relative w-1/3">
            <img
              src={assets.home_2}
              alt=""
              className={`h-32 md:h-44 w-full rounded-r-xl transition-all duration-700 ease-in-out ${
                loaded ? "blur-0" : "blur-md"
              }`}
              loading="lazy"
              onLoad={() => setLoaded(true)}
