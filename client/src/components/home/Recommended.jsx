    ...
    return (
        <div className='py-6 md:py-10 xl:py-14 flex flex-col gap-6 md:gap-12 lg:gap-24 old-standard-tt'>
            <div className='flex flex-col items-start gap-2.5 md:gap-3.5 lg:gap-5'>
                <div className='uppercase text-[#859F3E] font-bold text-lg md:text-xl lg:text-[1.75rem]'>Highly recommended Properties</div>
                <div className='w-2/3 capitalize text-[#31511E] font-normal text-2xl md:text-4xl lg:text-6xl leading-tight lg:leading-[4.5rem]'>Explore top farms and premium produce, handpicked for quality.</div>
            </div>
            <div className="w-full flex items-end justify-end">
                <div className='relative z-2 translate-y-1/3 translate-x-1/2 flex items-center justify-center gap-3 md:gap-4 lg:gap-5'>
                    <button
