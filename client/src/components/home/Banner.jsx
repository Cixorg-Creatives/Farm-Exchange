  ...
  return (
    <div className='py-4 md:py-10 lg:py-20'>
      <div className='w-full relative'>
        <img src={assets.home_21} alt="" className='w-full h-full object-cover' />
        <div className='absolute inset-0 bg-black/40 flex flex-col items-center justify-center gap-6 md:gap-8 lg:gap-10 px-4 md:px-8'>
          ...
          <div>
            <Button className='flex items-center justify-center gap-1 md:gap-2 lg:gap-3 bg-[#859F3E] w-40 h-12 md:w-60 md:h-16 lg:w-72 lg:h-20 old-standard-tt text-white text-sm md:text-lg lg:text-2xl font-bold leading-6 md:leading-7 lg:leading-8'>
