  ...
  return (
    <div className='my-6 md:my-10 xl:my-14 old-standard-tt'>
      <div className="flex flex-col md:flex-row items-center justify-between w-full py-4 md:py-11">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-end justify-start h-full text-start md:text-right">
          <p className="capitalize text-[#859F3E] font-bold text-2xl md:text-4xl leading-10 md:leading-12">
      ...
      <div className='grid grid-cols-1 md:grid-cols-[1fr_1fr] md:[&>*:nth-child(1)]:order-2 gap-6 md:gap-20 py-3 md:py-16'>
        ...
        <div className='col-span-1 bg-[#859F3E1A] py-14 px-6'>
