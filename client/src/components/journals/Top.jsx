    ...
    <div className='py-6 md:py-10 xl:py-14 old-standard-tt'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-1.5 md:gap-x-3 lg:gap-x-5'>
        <div className='h-full grid-cols-1 gap-y-2 md:gap-y-3 lg:gap-y-4 flex flex-row md:flex-col justify-between'>
          <Link to={'/journal/1'} className='px-2 md:px-4 lg:px-8 py-2.5 md:py-5 lg:py-9 border-1 border-[#D9E1C3] flex flex-col items-start gap-1 md:gap-2 lg:gap-4 cursor-pointer'>
        ...
        <Link to={'/journal/1'} className='h-full grid-cols-1 px-2 md:px-4 lg:px-8 py-2.5 md:py-5 lg:py-9 border-1 border-[#D9E1C3] flex flex-col items-start gap-3 md:gap-7 lg:gap-14 cursor-pointer'>
