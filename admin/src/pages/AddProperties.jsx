...
const propertySchema = z.object({
  ...
  gallery: z.array(z.string().min(1, "Gallery image URL is required")).min(1, "At least one gallery image is required"),
  price: z.object({
    value: z.number({
...
const AddProperties = () => {
  ...
  useEffect(() => {
    ...
    const fetchProperty = async () => {
      try {
        const response = await fetch(`http://localhost:3000/edit-properties/${propertyId}`);
        if (!response.ok) {
  ...
  const handleSubmit = async (e, status) => {
    ...
    try {
      ...
      toast.success(`Property ${status === 'published' ? 'published' : 'saved as draft'} successfully!`);
      if (!propertyId) {
        resetForm();
      }
    } catch (error) {
        ...
        <div className="grid grid-cols-[1fr_1fr] md:grid-cols-[1fr_1fr_1fr_1fr] items-center gap-2 md:gap-3 lg:gap-4">
          ...
          <div className="col-span-1 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            <Select
              ...
              onSelect={(value) => handleSelectChange('availabilityStatus', value)}
              selectedOption={formData.availabilityStatus}
            />
            {errors.availabilityStatus && <p className="text-red-500 text-xs">{errors.availabilityStatus}</p>}
          </div>
            ...
            <div className="flex items-center justify-between bg-[#C7D3A6] rounded-md lg:rounded-lg">
              <div className="flex items-center gap-1 md:gap-2 lg:gap-3 w-full ml-1 md:ml-2 lg:ml-4">
                ...
                <input
                  ...
                  onChange={(e) => handleNestedInputChange('price', 'value', e.target.value)}
              ...
              <Select
                ...
                onSelect={(value) => handleNestedInputChange('price', 'unit', value)}
                selectedOption={formData.price.unit}
              />
            </div>
            {errors.price?.value && <p className="text-red-500 text-xs">{errors.price.value}</p>}
          </div>
            ...
            <div className="flex items-center justify-between bg-[#C7D3A6] rounded-md lg:rounded-lg">
              <div className="flex items-center gap-1 md:gap-2 lg:gap-3 w-full ml-1 md:ml-2 lg:ml-4">
                ...
                <input
                  ...
                  onChange={(e) => handleNestedInputChange('pricePerArea', 'value', e.target.value)}
                  className="w-full capitalize text-[#1B2D11] font-normal text-xs md:text-sm lg:text-base py-2 md:py-3 lg:py-4 leading-tight h-10 md:h-12 lg:h-14 rounded-md lg:rounded-lg bg-transparent outline-none"
                  placeholder="0.00"
                />
              </div>
              <Select
                options={priceUnitSelect}
                onSelect={(value) => handleNestedInputChange('pricePerArea', 'unit', value)}
                selectedOption={formData.pricePerArea.unit}
              />
            </div>
            {errors.pricePerArea?.value && <p className="text-red-500 text-xs">{errors.pricePerArea.value}</p>}
          </div>
          ...
          <div className="col-span-1 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            <div className="flex items-center justify-between bg-[#C7D3A6] rounded-md lg:rounded-lg">
              <input
                ...
                onChange={(e) => handleNestedInputChange('plotArea', 'value', e.target.value)}
              ...
              <Select
                ...
                onSelect={(value) => handleNestedInputChange('plotArea', 'unit', value)}
                selectedOption={formData.plotArea.unit}
              />
            </div>
            {errors.plotArea?.value && <p className="text-red-500 text-xs">{errors.plotArea.value}</p>}
          </div>
          ...
          <div className="col-span-1 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            <div className="flex items-center justify-between bg-[#C7D3A6] rounded-md lg:rounded-lg">
              <input
                ...
                onChange={(e) => handleNestedInputChange('totalProjectArea', 'value', e.target.value)}
                className="w-full capitalize text-[#1B2D11] font-normal text-xs md:text-sm lg:text-base p-2 md:p-3 lg:p-4 leading-tight h-10 md:h-12 lg:h-14 rounded-md lg:rounded-lg bg-transparent outline-none"
                placeholder="0.00"
              />
              <Select
                options={areaUnitSelect}
                onSelect={(value) => handleNestedInputChange('totalProjectArea', 'unit', value)}
                selectedOption={formData.totalProjectArea.unit}
              />
            </div>
            {errors.totalProjectArea?.value && <p className="text-red-500 text-xs">{errors.totalProjectArea.value}</p>}
          </div>
          ...
          <div className="col-span-4 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            />
            {errors.propertyDescription && <p className="text-red-500 text-xs">{errors.propertyDescription}</p>}
          </div>
          ...
          <div className="col-span-4 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            />
            {errors.projectAbout && <p className="text-red-500 text-xs">{errors.projectAbout}</p>}
          </div>
              ...
              {formData.amenities.map((amenity, index) => (
                ...
                >
                  ...
                  {errors.amenities?.[index]?.name && (
                    <p className="text-red-500 text-xs">{errors.amenities[index].name}</p>
                  )}
                  {errors.amenities?.[index]?.image && (
                    <p className="text-red-500 text-xs">{errors.amenities[index].image}</p>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="col-span-1 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            <input
              ...
              onChange={(e) => handleNestedInputChange('location', 'locality', e.target.value)}
              className="w-full bg-[#C7D3A6] capitalize text-[#1B2D11] font-normal text-xs md:text-sm lg:text-base p-2 md:p-3 lg:p-4 leading-tight h-10 md:h-12 lg:h-14 rounded-md lg:rounded-lg outline-none"
              placeholder="Locality"
            />
            {errors.location?.locality && <p className="text-red-500 text-xs">{errors.location.locality}</p>}
          </div>
          ...
          <div className="col-span-1 w-full flex flex-col items-start gap-1 md:gap-2 lg:gap-3">
            ...
            <input
              ...
              placeholder="City"
            />
            {errors.location?.city && <p className="text-red-500 text-xs">{errors.location.city}</p>}
          </div>
