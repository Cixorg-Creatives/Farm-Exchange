...
const EditProfile = () => {
    ...
    return (
        <div className='px-5 md:px-8 xl:px-12'>
            ...
            {loading ? <Loader /> : (
                <div>
                    <h1 className="boska w-full uppercase text-black font-semibold text-lg lg:text-[2rem]">Edit Profile</h1>
                    <div className='grid grid-cols-1 md:grid-cols-[1fr_4fr] items-start my-6'>
                        <div className='flex flex-col items-center gap-3'>
                            <label htmlFor="uploadImg" className="relative block w-48 h-48 bg-[#f3f3f3] rounded-full overflow-hidden">
                        ...
                        <div className='flex flex-wrap gap-4 px-5'>
                            ...
                            <div className='w-full md:w-[24rem] bg-[#C7D3A6] p-4 rounded-md'>
                            ...
                            <form ref={changePasswordForm} onSubmit={handleSubmitPassword} className="flex flex-col gap-4" >
                                <div className="flex gap-4">
                                    <div className='w-full md:w-[24rem] bg-[#C7D3A6] p-4 rounded-md flex items-center gap-3'>
