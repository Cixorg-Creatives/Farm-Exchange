...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between mt-3 py-1 px-7 md:mt-5 md:py-2 md:px-28 w-full h-fit bg-[#073D2C] clashdisplay'>
            ...
            <button onClick={handleLogout} className='bg-[#859F3E] border border-[#495823] px-5 py-2 sm:px-7 sm:py-2 rounded-full text-xs md:text-base lg:text-xl text-white font-normal flex gap-2 items-center justify-between'>Logout<LogOut className='h-3 md:h-4 lg:h-5 w-auto' /></button>
        </div>
    )
}
