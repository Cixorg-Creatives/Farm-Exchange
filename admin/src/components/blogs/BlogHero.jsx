...
const BlogHero = () => {
    return (
        <div className='my-2 md:my-4 xl:my-6 flex flex-col items-start clashdisplay'>
            ...
            <p className='uppercase prata text-[#31511E] font-semibold text-3xl md:text-6xl lg:text-[6.25rem] leading-tight md:leading-snug'>The Story Behind Farm Exchange</p>
